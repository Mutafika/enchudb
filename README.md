...
enabled and the v9 version columns are allocated) but costs a few hundred KB on disk. `df` does not move. This is by design — but it has three consequences worth
knowing.
